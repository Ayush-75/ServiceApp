...
public class MyLocation {
    ...
    speedAccracyMetersPerSecond,verticalAccuracyMeters;
    ...
    public int getSpeedAccracyMetersPerSecond() {
        return speedAccracyMetersPerSecond;
    }

    public void setSpeedAccracyMetersPerSecond(int speedAccracyMetersPerSecond) {
        this.speedAccracyMetersPerSecond = speedAccracyMetersPerSecond;
    }
